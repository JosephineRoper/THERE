...
THERE is a collection of algorithms using the Python open-source geospatial ecosystem to calculate accessibility across multiple modes, for any area in the world. The model of accessibility is based on my PhD research, the following paper explains the theoretical basis for its design. Please cite this paper if using this code:
